...
export const languages = [
  ...
  "Irish", "Welsh", "Scottish Gaelic", "Breton", "Basque", "Catalan", "Galician", "Corsican", "Sardinian",
  ...
  "Panamint", "Shoshone", "Gosiute", "Bannock", "Comanche", "Ute", "Paiute", "Mono", "Tubatulabal", "Kawaiisu",
  "Afar", "Abkhazan", "Avestan", "Avaric", "Bislama", "Chamorro", "Chechen", "Chuvash", "Divehi", "Dzongkha",
  "Fijian", "Guarani", "Herero", "Hiri Motu", "Inupiaq", "Inuktitut", "Javanese", "Kalaallisut", "Kanuri", "Kashmiri",
  "Kikuyu", "Komi", "Kongo", "Kwanyama", "Limburgish", "Lingala", "Luba-Katanga", "Marshallese", "Nauru", "Ndonga",
  "Northern Sami", "Nyanja", "Oromo", "Ossetian", "Pali", "Sango", "Sanskrit", "Sichuan Yi", "South Ndebele", "Sundanese",
  "Tahitian", "Venda", "Volapük", "Walloon", "Yi", "Zhuang", "Akan", "Aragonese", "Bambara", "Bashkir",
  "Bislama", "Chuvash", "Cornish", "Corsican", "Ewe", "Faroese", "Frisian", "Fula", "Galician", "Ganda",
  "Guarani", "Herero", "Hiri Motu", "Ido", "Interlingua", "Interlingue", "Inupiaq", "Inuktitut", "Javanese", "Kalaallisut"
];
